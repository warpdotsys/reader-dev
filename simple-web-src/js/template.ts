...
;(function(root: any, factory: any) {
    ...
    var o = {
        ...
        error: function (e: any) {} // Error callback
    };

    var functionMap: any = {}; // Registered template functions
    ...
    function isObject(obj: any): boolean { return type(obj) === 'object'; }
    function isFunction(fn: any): boolean { return type(fn) === 'function'; }
    function isString(str: any): boolean { return type(str) === 'string'; }
    ...
    function nothing(param: any): any {
        return param;
    }
     ...
     */
    function encodeHTML(source: any): string {
     ...
     */
    function compress(html: string): string {
     ...
     */
    function consoleAdapter(cmd: string, msg: any) {
     ...
     */
    function handelError(e: any): any {
     ...
     */
    function parse(tpl: string, opt: any): string {
        var code = '';
        var sTag = opt.sTag;
        var eTag = opt.eTag;
        ...
        function parsehtml(line: string): string {
        ...
        function parsejs(line: string): string {
            var reg = /^(?:=|(:.*?)=)(.*)$/;
            var html: any;
            var arr: any;
            var modifier: any;
     ...
     */
    function compiler(tpl: string, opt: any): any {
     ...
     */
    function compile(tpl: string, opt?: any): any {
        opt = clone(o, opt);
     ...
     */
    function template(tpl: string, data?: any): any {
     ...
     */
    template.generate = function (render: any, data: any, opt?: any): any {
        opt = clone(o, opt);
        data = clone(functionMap, data);
        try {
            var html = render(data, modifierMap);
     ...
     */
    template.config = function (option: any): any {
        if (isObject(option)) {
            o = extend(o, option);
        }
        return clone(o);
     ...
     */
    template.registerFunction = function(name: any, fn: any): any {
        if (!isString(name)) {
    ...
    template.unregisterFunction = function (name: any): any {
        if (!isString(name)) {
            return false;
        }
     ...
     */
    template.registerModifier = function(name: any, fn: any): any {
        if (!isString(name)) {
    ...
    template.unregisterModifier = function (name: any): any {
        if (!isString(name)) {
            return false;
        }
