...
function computeShowBookList() {
    ...
    allBooks = allBooks.sort(function (a: any, b: any) {
...
function onPageInit() {
    ...
    showBookListWatcher.onChange(function (books: any) {
        if (books && books.length > 0) {
            renderTmpl("bookList", { list: books, isLoading: false, isSearch: false }, function (html: string) {
                container.html("");
 ...
 */
function showBookInfo(index: number) {
    bookInfoWatcher.onChange(function (bookInfo: any) {
        renderTmpl("bookInfo", {
            bookInfo: bookInfo,
            isSearch: false,
...
function refreshChapterList(bookUrl: string) {
    $.ajax.post("/getChapterList", { url: bookUrl }, function (resp: string) {
