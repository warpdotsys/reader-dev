 ...
 */
function loadLink(href, onload, rel, type) {
 ...
 */
function getQueryString(name, caseSensitive) {
...
if (typeof Set === 'undefined' || !isNative(Set)) {
    window.Set = function (items) {
        ...
        this.has = function (value) { return this.set[value] === true; };
        this.add = function (value) { this.set[value] = true; };
 ...
 */
_$.fn.each = function (fn, returnValues) {
    var results = [];
...
_$.fn.css = function (property, value, priority) {
    if (value !== undefined) {
...
_$.fn.tag = function (tagName) {
    this[0] = document.createElement(tagName);
    return this;
};

_$.fn.dom = function (htmlString) {
 ...
 */
_$.fn.on = function (eventType, delegateSelector, handler) {
    if (!handler) {
...
_$.fn.once = function (eventType, handler) {
...
_$.ajax = {
    ...
    onResponse: function (responseText) { return responseText; },
