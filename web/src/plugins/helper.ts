...
export const formatSize = function(value: any, scale?: number) {
  if (value == null || value == "") {
    return "0 Bytes";
  }
...
export const LimitResquest = function(limit: number, process?: Function) {
  let currentSum = 0;
  let requests = [];
...
export const editDistance = function(strA: string, strB: string) {
...
export const loadFont = function(fontName: string, fontUrl: string) {
...
export const removeFont = function(fontName: string) {
  window.customFonts = window.customFonts || {};
