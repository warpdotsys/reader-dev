...
const jumper = () => {
  ...
  let container: any; // container element to be scrolled       (node)
  let element: any; // element to scroll to                   (node)
  ...
  let easing: any; // easing function                        (function)
  let a11y: boolean; // accessibility support flag             (boolean)

  let distance: number; // distance of scroll                     (px)
  let duration: any; // scroll duration                        (ms)

  let timeStart: any; // time scroll started                    (ms)
