...
export const FileManager = {
  ...
  methods: {
    ...
    filterHandler(value: string, row: any) {
      switch (value) {
        case "imported":
    ...
    filterAuthor(value: string, row: any) {
    ...
    operateFile(row: any, action: string) {
...
export const FileManagerTemplate = `<template>
  <el-dialog
    :title="title"
    :visible.sync="show"
    :width="dialogWidth"
...
export const FileManagerStyle = `<style lang="stylus" scoped>
.float-left {
  float: left;
}
.float-right {
