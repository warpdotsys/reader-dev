...
export const ReadSettings = {
  ...
  methods: {
    ...
    setReadMethod(readMethod: string) {
      this.$emit("readMethodChange");
      this.config = { ...this.config, readMethod };
    },
    setEpubMode(epubMode: string) {
      this.$emit("epubModeChange");
      this.config = { ...this.config, epubMode };
    },
    setQuickKeyMode(quickKeyMode: string) {
      this.config = { ...this.config, quickKeyMode };
    },
    setQuickKeyOpt(key: string, option: string) {
      this.config = {
        ...this.config,
    ...
    async uploadFontFile(customFontName: string, fontName: string) {
      if (
    ...
    setCustomConfig(customConfig: any) {
      this.config = {
        ...this.config,
    ...
    async deleteCustomConfig(index: number, name: string) {
    ...
    async setConfigDefaultType(configDefaultType: string) {
      const res = await this.$confirm(
...
export const ReadSettingsTemplate = `<template>
  <div
...
export const ReadSettingsStyle = `<style lang="stylus" scoped>
>>>.iconfont {
...
export const ReadSettingsStyleGlobal = `<style lang="stylus">
.setting-input {
  .el-input__inner {
