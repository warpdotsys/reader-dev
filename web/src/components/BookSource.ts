...
export const BookSource = {
  ...
  watch: {
    ...
    readingBook(val: any, oldVal: any) {
  ...
  methods: {
    ...
    async changeBookSource(searchBook: any) {
...
export const BookSourceTemplate = `<template>
...
export const BookSourceStyle = `<style lang="stylus" scoped>
.popup-wrapper {
  margin: -16px;
  margin-bottom: -13px;
  padding: 24px;
