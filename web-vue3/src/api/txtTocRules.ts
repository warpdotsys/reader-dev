 ...
 * POST /reader3/deleteTxtTocRule           body: { id: number|string } → ReturnData<null>
...
export function saveTxtTocRule(rule: TxtTocRule): Promise<ReturnData<{ id?: string | number } | null>> {
  return post<{ id?: string | number } | null>('/saveTxtTocRule', rule)
}

/** POST /reader3/deleteTxtTocRule：按 id 删除 */
export function deleteTxtTocRule(id: string | number): Promise<ReturnData<null>> {
