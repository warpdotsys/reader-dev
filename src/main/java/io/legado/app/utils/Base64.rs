...
impl Base64 {
    ...
    impl Decoder {
        pub fn new(flags: i32, output: Vec<u8>) -> Decoder {
            Decoder {
                ...
                state: 0,
                value: 0,
                alphabet: if (flags & Self::URL_SAFE) == 0 { &Self::DECODE } else { &Self::DECODE_WEBSAFE },
            }
        }
    ...
    impl Encoder {
        pub fn new(flags: i32, output: Option<Vec<u8>>) -> Encoder {
            let do_padding = (flags & Self::NO_PADDING) == 0;
            let do_newline = (flags & Self::NO_WRAP) == 0;
            let do_cr = (flags & Self::CRLF) != 0;
            ...
            Encoder {
                ...
                do_newline,
                do_cr,
                alphabet: if (flags & Self::URL_SAFE) == 0 { &Self::ENCODE } else { &Self::ENCODE_WEBSAFE },
            }
        }
